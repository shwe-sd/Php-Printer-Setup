        ...
        foreach ($rowGroups as $rowGroup) {
            ...
            foreach ($rowGroup as $row) {
                ...
                if ($this->horizontal) {
                    ...
                    // echo 'is it calling?';
                    $customRet = $this->renderRow($row, $isHeader ? $this->style->getCellHeaderFormat() : $this->style->getCellRowFormat());
                    // echo str_replace('<fg=default;bg=default></>', '', $customRet);
                    array_push($retList, str_replace('<fg=default;bg=default></>', '', $customRet));
                }
            }
        }
